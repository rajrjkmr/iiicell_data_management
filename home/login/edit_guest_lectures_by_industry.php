...
$userid=$_SESSION['myValue'];
 ...
 $sql="UPDATE guest_lectures_by_industry SET NAME_OF_THE_ORGANISATION='$company_name',PERSON_CONTACTED='$person_contacted',CONTACT_NUMBER='$contact_number',OUTCOME='$outcome',dept='$dept',userid='$userid' WHERE id='$id'";
...
$sql="SELECT *FROM guest_lectures_by_industry where ID='$id'";
