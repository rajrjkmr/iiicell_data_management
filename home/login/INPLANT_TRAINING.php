...
$sql = "SELECT * FROM inplant_training ";  
...
<?php
 while($row = mysqli_fetch_assoc($retval))
	 { 
	 	 $id=$row['ID'];
 echo '<tr>';
 echo '<td>'.$row['COMPANY_NAME'].'</td><td>'.$row['PERSON_CONTACTED'].'</td><td>'.$row['CONTACT_NUMBER'].'</td><td>'.$row['OUTCOME'].'</td><td>'.$row['SUBMIT_DATE'].'</td><td>'.$row['USERID'].'</td>';?><td><a href="delete_inplant_training.php?id=<?php echo $id; ?>" 
    onclick="return confirm('Are you sure you wish to delete this Record?');">
  	          <span class="delete" title="Delete"> X </span></a></td><td><a href="edit_inplant_training.php?id=<?php echo $id; ?>"><span class="edit" title="Edit"> E </span></a></td><!-- <td>
...
$sql = "SELECT *FROM inplant_training WHERE dept='$dept'";  
$retval=mysqli_query($conn, $sql);  
...
{  
 ...
 while($row = mysqli_fetch_assoc($retval))
	 { 
	 	$id=$row['ID'];
 echo '<tr>';
 echo '<td>'.$row['COMPANY_NAME'].'</td><td>'.$row['PERSON_CONTACTED'].'</td><td>'.$row['CONTACT_NUMBER'].'</td><td>'.$row['OUTCOME'].'</td><td>'.$row['SUBMIT_DATE'].'</td>';?><td><a href="delete_inplant_training.php?id=<?php echo $id; ?>" 
    onclick="return confirm('Are you sure you wish to delete this Record?');">
            <span class="delete" title="Delete"> X </span></a></td><td><a href="edit_inplant_training.php?id=<?php echo $id; ?>"><span class="edit" title="Edit"> E </span></a></td><?php
echo '<tr>';
