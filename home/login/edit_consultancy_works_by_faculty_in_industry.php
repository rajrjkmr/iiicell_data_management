...
$userid=$_SESSION['myValue'];
 ...
 $sql="UPDATE consultancy_works_by_faculty_in_industry SET COMPANY_NAME='$COMPANY_NAME',PERSON_CONTACTED='$person_contacted',CONTACT_NUMBER='$contact_number',CURRENT_STATUS='$CURRENT_STATUS',dept='$dept',userid='$userid' WHERE id='$id'";
if(mysqli_query($conn, $sql)){  
 header("Location:CONSULTANCY_WORKS_BY_FACULTY_IN_INDUSTRY.php");
}else{  
...
<p style="font-size:30pt;color:pink;font-family=Regular;"> <b>CONSULTANCY WORKS BY FACULTY IN INDUSTRY </b></P></center>
<?php
$servername = "localhost";
$username = "raj";
$password = "raj";
...
$sql="SELECT *FROM consultancy_works_by_faculty_in_industry where id='$id'";
