...
$userid=$_SESSION['myValue'];
 ...
 $sql="UPDATE awards_for_institution SET AGENCY_NAME='$company_name',PERSON_CONTACTED='$person_contacted',CONTACT_NUMBER='$contact_number',CURRENT_STATUS='$outcome',dept='$dept',userid='$userid' WHERE id='$id'";
...
$sql="SELECT *FROM awards_for_institution where ID='$id'";
...
<center><fieldset>
<label ><span>AGENCY NAME: <span class="required"></span></span><input type="text" class="input-field" name="company_name" value="<?php echo "$company_name"; ?>" /></label>
