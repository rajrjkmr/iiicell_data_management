...
$userid=$_SESSION['myValue'];
 ...
 $sql="UPDATE industrial_visit_during_vacation SET COMPANY_NAME='$company_name',PERSON_CONTACTED='$person_contacted',CONTACT_NUMBER='$contact_number',OUTCOME='$outcome',DEPT='$dept',USERID='$userid' WHERE id='$id'";
...
<p style="font-size:30pt;color:pink;font-family=Regular;"> <b>INDUSTRIAL VISIT DURING VACATION </b></P></center>
<?php
$servername = "localhost";
$username = "raj";
$password = "raj";
...
$sql="SELECT *FROM industrial_visit_during_vacation where id='$id'";
