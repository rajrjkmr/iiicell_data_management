...
{    
	$NAME_OF_THE_ORGANISATION=$_POST["NAME_OF_THE_ORGANISATION"];
...
$userid=$_SESSION['myValue'];
 ...
 $sql="UPDATE mov SET NAME_OF_THE_ORGANISATION='$NAME_OF_THE_ORGANISATION',PERSON_CONTACTED='$person_contacted',CONTACT_NUMBER='$contact_number',STATUS='$STATUS',dept='$dept',userid='$userid' WHERE id='$id'";
...
<p style="font-size:30pt;color:pink;font-family=Regular;"> <b>MOU </b></P></center>
<?php
$servername = "localhost";
$username = "raj";
$password = "raj";
...
$sql="SELECT *FROM mov where id='$id'";
 $result_set=mysqli_query($conn, $sql);
 while($row=mysqli_fetch_array($result_set))
 {
 	$NAME_OF_THE_ORGANISATION=$row['NAME_OF_THE_ORGANISATION'];
...
<center><fieldset>
<label ><span>NAME OF THE ORGANISATION: <span class="required"></span></span><input type="text" class="input-field" name="NAME_OF_THE_ORGANISATION" value="<?php echo "$NAME_OF_THE_ORGANISATION"; ?>" /></label>
