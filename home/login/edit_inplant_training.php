...
$userid=$_SESSION['myValue'];
 ...
 $sql="UPDATE inplant_training SET COMPANY_NAME='$company_name',PERSON_CONTACTED='$person_contacted',CONTACT_NUMBER='$contact_number',OUTCOME='$outcome',dept='$dept',userid='$userid' WHERE id='$id'";
...
$sql="SELECT *FROM inplant_training where ID='$id'";
