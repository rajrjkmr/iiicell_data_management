...
$userid=$_SESSION['myValue'];
 ...
 $sql="UPDATE ranking_of_the_institution SET AGECNY_NAME='$AGECNY_NAME',PERSON_CONTACTED='$person_contacted',CONTACT_NUMBER='$contact_number',CURRENT_STATUS='$CURRENT_STATUS',dept='$dept',userid='$userid' WHERE id='$id'";
...
<p style="font-size:30pt;color:pink;font-family=Regular;"> <b>RANKING OF THE INSTITUTION </b></P></center>
<?php
$servername = "localhost";
$username = "raj";
$password = "raj";
...
$sql="SELECT *FROM ranking_of_the_institution where id='$id'";
 $result_set=mysqli_query($conn, $sql);
 while($row=mysqli_fetch_array($result_set))
 {
 	$AGECNY_NAME=$row['AGECNY_NAME'];
...
<center><fieldset>
<label ><span>COMPANY NAME: <span class="required"></span></span><input type="text" class="input-field" name="AGECNY_NAME" value="<?php echo "$AGECNY_NAME"; ?>" /></label>
